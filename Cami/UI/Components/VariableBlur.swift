...
//
    ...
    open class VariableBlurUIView: UIVisualEffectView {
        init(
            ...
            guard let variableBlur = CAFilter.perform(NSSelectorFromString("filterWithType:"), with: "variableBlur")
        ...
        private func makeGradientImage(
            ...
            ciGradientFilter
                .point1 = CGPoint(x: 0, y: startOffset * height) // small negative looks better with vertical lines
