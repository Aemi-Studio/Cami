...
extension ButtonStyle where Self == CustomBorderedButtonStyle {
    ...
    private static var accentBackgroundStyle: AnyShapeStyle {
        colorScheme == .dark
            ? AnyShapeStyle(.tint.secondary)
            : AnyShapeStyle(.tint.tertiary)
    }

    private static var secondaryBackgroundStyle: AnyShapeStyle {
        colorScheme == .dark
            ? AnyShapeStyle(Color.primary.secondary)
    ...
    static var secondary: CustomBorderedButtonStyle {
        CustomBorderedButtonStyle(
            ...
            backgroundStyle: secondaryBackgroundStyle
        )
    }
    ...
    static var accent: CustomBorderedButtonStyle {
        CustomBorderedButtonStyle(
            backgroundStyle: accentBackgroundStyle
        )
    }
