    ...
    private var callToAction: some View {
        if isValid {
            Label(
                ...
                systemImage: isDrawerOpen ? "chevron.up" : "chevron.down"
            )
            ...
            HStack {
                if isUnknown {
                    Label("Next", systemImage: "arrow.forward.square.fill")
                        .labelStyle(.titleOnly)
                } else {
                    Label("Review", systemImage: "arrow.up.right.square.fill")
